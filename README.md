...
* `janus-plugins` contains all additional vim plugins that are loaded within Janus. It is auto-generated using a command [like this](https://gist.github.com/2436641).
